...
import { IUpdatePhoneNumber } from "@/types/auth/user/user.type";
import { useFormik } from "formik";
import { clearError, updatePhoneNumber } from "@/features/auth/user/userSlice";
import { unwrapResult } from "@reduxjs/toolkit";
import { useToastError } from "@/hooks/useToastError";
import { PHONE_NUMBER_ACTION, Resource } from "@/types/enum.types";
...
const PhoneNumberModal: FC<Props> = ({ open, onClose }) => {
  ...
  const { me, LOADING_UPDATE_PHONE_NUMBER, ERROR_UPDATE_PHONE_NUMBER } =
