...
import { IUpdateEmail } from "@/types/auth/user/user.type";
import { checkEmptyString } from "@/utils/checkValues";
import { useFormik } from "formik";
import { clearError, updateEmail } from "@/features/auth/user/userSlice";
...
const EmailModal: FC<Props> = ({ open, onClose }) => {
  ...
  const { me, LOADING_UPDATE_EMAIL, ERROR_UPDATE_EMAIL } = useAppSelector(
