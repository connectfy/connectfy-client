...
import { IDeleteAccount } from "@/types/auth/auth/auth.type";
import { DELETE_REASON, Resource } from "@/types/enum.types";
import { useAppDispatch, useAppSelector } from "@/hooks/useStore";
import { useFormik } from "formik";
import { checkEmptyString } from "@/utils/checkValues";
import { TriangleAlert } from "lucide-react";
import { clearError, deleteAccount } from "@/features/auth/auth/authSlice";
...
const DeleteAccountModal: FC<Props> = ({ open, onClose }) => {
  ...
  const { authToken, LOADING_DELETE_ACCOUNT, ERROR_DELETE_ACCOUNT } =
    ...
    <Modal open={open} onClose={onClose}>
      <div className="delete-account-modal">
        <div className="delete-account-modal-header">
          ...
          <h2 className="delete-account-modal-title">{t("common.delete_account_title")}</h2>
